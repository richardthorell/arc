...
constexpr arc::project::game_field_descriptor_v1 fields[]{
    {0x1111111111111111ull, "renamed_value", "Value", "Test", "Fixture value",
     ...
     arc::project::game_field_flags_v1::editable | arc::project::game_field_flags_v1::serialized, "1", 0.0, 10.0, true,
     true},
};
constexpr arc::project::game_component_descriptor_v1 components[]{
    {"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "renamed_component", "Fixture Component", "Test", "Fixture", 3, fields,
     std::size(fields)},
};
