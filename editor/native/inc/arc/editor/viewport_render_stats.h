 ...
 * terrain triangle counts. Vertex totals are marked incomplete when those paths
 * are active because their backend profiles do not expose selected vertex
 * counts. GPU memory reflects the backend capability snapshot when available.
 */
