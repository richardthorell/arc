...
> = [
    ...
    fields: [
      {
        ...
        type: 'enum',
        options: [
          { value: 'manualLight', label: 'Manual Light' },
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'systemClock', label: 'System Clock' },
        ],
  ...
  },
  {
    ...
    visible: (value) => value.skySource === 'physicalAtmosphere',
    fields: [
      {
        id: 'tint',
      ...
      {
        id: 'rayleighHeight',
        label: 'Rayleigh Height',
        path: 'rayleighScaleHeight',
        type: 'number',
        precision: 2,
        step: 0.1,
        scrubSensitivity: 0.02,
      ...
      {
        id: 'sunDiskPower',
        label: 'Sun Disk Power',
        path: 'sunDiskIntensity',
        type: 'number',
        precision: 2,
        step: 0.05,
        scrubSensitivity: 0.01,
  ...
  },
  {
    ...
    fields: [
      { id: 'moon', label: 'Moon', path: 'moonEnabled', type: 'boolean' },
      {
        ...
        path: 'automaticMoonPhase',
        type: 'boolean',
        visible: (value) => value.moonEnabled,
      },
      {
        id: 'moonPhase',
        label: 'Moon Phase',
      ...
      {
        id: 'moonRadius',
        label: 'Angular Radius',
        path: 'moonAngularRadiusDegrees',
        type: 'number',
        precision: 2,
        step: 0.01,
        scrubSensitivity: 0.002,
      ...
      { id: 'stars', label: 'Stars', path: 'starsEnabled', type: 'boolean' },
      {
        ...
        min: 0,
        max: 1,
        visible: (value) => value.starsEnabled,
      },
      {
        id: 'starIntensity',
  ...
  },
  {
    ...
    fields: [
      { id: 'enabled', label: 'Enabled', path: 'cloudsEnabled', type: 'boolean' },
      {
        ...
        path: 'cloudShadows',
        type: 'boolean',
        visible: (value) => value.cloudsEnabled,
      },
    ],
  },
  {
    id: 'cumulus',
    title: 'Cumulus Cloud Layer',
    visible: (value) => value.cloudsEnabled,
    fields: cloudLayerFields('cumulus'),
  },
  {
    id: 'cirrus',
    title: 'Cirrus Cloud Layer',
    visible: (value) => value.cloudsEnabled,
    fields: cloudLayerFields('cirrus'),
  },
  {
    id: 'fog',
    title: 'Fog',
    fields: [
      { id: 'enabled', label: 'Enabled', path: 'fogEnabled', type: 'boolean' },
      {
        ...
        max: 1,
        alpha: false,
        visible: (value) => value.fogEnabled,
      },
      {
        id: 'density',
        label: 'Density',
  ...
  },
  {
    ...
    fields: [
      { id: 'enabled', label: 'Enabled', path: 'lightingEnabled', type: 'boolean' },
      {
        id: 'source',
        label: 'Source',
        ariaLabel: 'Environment Lighting Source',
        path: 'lightingSource',
        type: 'enum',
        options: [
          { value: 'followSky', label: 'Follow Sky' },
          { value: 'hdri', label: 'HDRI Texture' },
          { value: 'constantColor', label: 'Constant Color' },
        ],
  ...
  },
  {
    ...
    fields: [
      ...
      {
        id: 'emissiveContribution',
        label: 'Emissive Contribution',
        path: 'emissiveContribution',
        type: 'number',
        precision: 2,
        step: 0.05,
        scrubSensitivity: 0.01,
      ...
      {
        id: 'traceDistance',
        label: 'Maximum Trace Distance',
        path: 'maximumTraceDistance',
        type: 'number',
        precision: 1,
        step: 1,
      ...
      {
        id: 'cacheDetail',
        label: 'Surface Cache Detail',
        path: 'surfaceCacheDetail',
        type: 'number',
        precision: 2,
        step: 0.125,
        scrubSensitivity: 0.025,
        min: 0.125,
        max: 8,
        visible: (value) => value.indirectLightingEnabled,
      },
      {
        id: 'allowHardware',
        label: 'Allow Hardware Ray Tracing',
        path: 'allowHardwareRayTracing',
        type: 'boolean',
        visible: (value) => value.indirectLightingEnabled,
      },
    ],
