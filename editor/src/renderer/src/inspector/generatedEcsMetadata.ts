    ...
    fields: [
      {
        ...
        constraints: {},
        kind: 'string',
        flags: ['serialized', 'editable', 'prefab_override'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description:
          'Controls whether this renderer follows automatic motion-vector policy, always writes motion, or disables motion vectors.',
        unit: 'none',
        constraints: {},
        kind: 'enum',
        flags: ['serialized', 'editable', 'prefab_override'],
