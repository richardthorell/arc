...
export const inspectorComponentSchemas: ReadonlyArray<InspectorComponentSchema> = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'followCamera', label: 'Follow Camera', path: 'water.followCamera', type: 'boolean' },
      {
        id: 'visibleDistance',
      ...
      { id: 'foamEnabled', label: 'Foam Enabled', path: 'water.foamEnabled', type: 'boolean' },
      {
        id: 'foamThreshold',
        label: 'Foam Threshold',
        path: 'water.foamThreshold',
        type: 'number',
        precision: 2,
        step: 0.05,
        scrubSensitivity: 0.01,
        min: 0,
        max: 1,
        visible: (snapshot) => snapshot.water?.foamEnabled ?? false,
      },
      {
        id: 'foamDecay',
        label: 'Foam Decay',
        path: 'water.foamDecay',
        type: 'number',
        precision: 2,
        step: 0.05,
        scrubSensitivity: 0.01,
      ...
      { id: 'shorelineEnabled', label: 'Shoreline Enabled', path: 'water.shorelineEnabled', type: 'boolean' },
      {
        id: 'shorelineFoamWidth',
        label: 'Shoreline Foam Width',
        path: 'water.shorelineFoamWidth',
        type: 'number',
        precision: 2,
        step: 0.25,
        scrubSensitivity: 0.05,
        min: 0,
        unit: ' m',
        visible: (snapshot) => snapshot.water?.shorelineEnabled ?? false,
      },
      {
        id: 'shallowWaveDampingDistance',
        label: 'Shallow Damping Distance',
        path: 'water.shallowWaveDampingDistance',
        type: 'number',
        precision: 1,
        step: 1,
        scrubSensitivity: 0.2,
      ...
      {
        id: 'runupDistance',
        label: 'Runup Distance',
        path: 'water.runupDistance',
        type: 'number',
        precision: 2,
        step: 0.25,
        scrubSensitivity: 0.05,
      ...
      { id: 'underwaterEnabled', label: 'Underwater Enabled', path: 'water.underwaterEnabled', type: 'boolean' },
      { id: 'causticsEnabled', label: 'Caustics Enabled', path: 'water.causticsEnabled', type: 'boolean' },
      { id: 'queriesEnabled', label: 'Queries Enabled', path: 'water.queriesEnabled', type: 'boolean' },
      { id: 'buoyancyEnabled', label: 'Buoyancy Enabled', path: 'water.buoyancyEnabled', type: 'boolean' },
      {
        id: 'quality',
        label: 'Quality',
        path: 'water.quality',
