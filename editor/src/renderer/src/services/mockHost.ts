...
const project: ProjectSnapshot = {
  ...
  assets: [
    ...
    { id: 'asset-mesh-cube', name: 'cube.arcmesh', path: 'meshes/cube.arcmesh', kind: 'mesh', status: 'ready' },
    {
      ...
      name: 'default.arcmat',
      path: 'materials/default.arcmat',
      kind: 'material',
      status: 'ready',
    },
    {
      id: 'asset-material-grid',
      name: 'grid_floor.arcmat',
      path: 'materials/grid_floor.arcmat',
      kind: 'material',
      status: 'ready',
    },
    {
      id: 'asset-texture-checker',
      name: 'checker.ktx',
      path: 'textures/checker.ktx',
      kind: 'texture',
      status: 'ready',
    },
    { id: 'asset-shader-pbr', name: 'pbr_lit.hlsl', path: 'shaders/pbr_lit.hlsl', kind: 'shader', status: 'ready' },
    {
      id: 'asset-shader-outline',
      name: 'selection_outline.hlsl',
      path: 'shaders/selection_outline.hlsl',
      kind: 'shader',
      status: 'importing',
    },
  ],
  console: [
    {
      ...
      level: 'info',
      source: 'editor',
      message: 'Workbench initialized with mock host data.',
      timestamp: '09:41:12',
    },
    { id: 'event-2', level: 'info', source: 'project', message: 'Loaded project Arc Sandbox.', timestamp: '09:41:12' },
    {
      ...
      level: 'debug',
      source: 'renderer',
      message: 'Viewport is running in placeholder mode.',
      timestamp: '09:41:13',
    },
    {
      id: 'event-4',
      level: 'warning',
      source: 'assets',
      message: 'selection_outline.hlsl is still importing.',
      timestamp: '09:41:13',
    },
  ],
  renderStats: {
