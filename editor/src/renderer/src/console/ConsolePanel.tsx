    ...
    <section className="console-panel" aria-label="Console">
      <div className="console-toolbar">
        <button
          ...
          onClick={() => onClear(events)}
          type="button"
        >
          <Trash2 size={14} /> Clear
        </button>
        <button
          aria-label={locked ? 'Disable console scroll lock' : 'Enable console scroll lock'}
          aria-pressed={locked}
      ...
      <div
        className="bottom-content console-content"
        onKeyDown={unlockForManualScroll}
        onPointerDown={unlockForManualScroll}
        onWheel={unlockForManualScroll}
        ref={scrollRef}
        tabIndex={0}
      >
