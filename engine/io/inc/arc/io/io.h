...
template <class T> class file_result
{
public:
    ...
    const file_error& error() const noexcept
    {
        return error_;
    }
...
template <> class file_result<void>
{
public:
...
public:
    ...
    jobs::job_future<file_result<file_buffer>> read_all(std::filesystem::path path,
                                                        jobs::cancellation_token cancellation = {});
    jobs::job_future<file_result<file_buffer>> read_range(std::filesystem::path path, std::uint64_t offset,
                                                          std::size_t bytes,
                                                          jobs::cancellation_token cancellation = {});
    jobs::job_future<file_result<void>> write(std::filesystem::path path, std::span<const std::byte> bytes,
                                              jobs::cancellation_token cancellation = {});
    jobs::job_future<file_result<void>> write_atomic(std::filesystem::path path, std::span<const std::byte> bytes,
                                                     jobs::cancellation_token cancellation = {});
    jobs::job_future<file_result<file_info>> stat(std::filesystem::path path,
                                                  jobs::cancellation_token cancellation = {});
