    ...
    std::initializer_list<std::string> names = {})
{
    return registry.register_component({
        &ecs::component_metadata<Component>(),
    ...
    persistence::schema_migration_registry& registry)
{
    ...
    if (!registry.register_document(
        ...
        !registry.register_document(
            persistence::document_kind::scene, 2, 3, document_upgrade) ||
        !registry.register_document(
            persistence::document_kind::prefab, 1, 2, document_upgrade) ||
        !registry.register_component(
            ecs::component_metadata<terrain_component>().id, 1, 2,
            component_upgrade) ||
        !registry.register_component(
            ecs::component_metadata<camera_component>().id, 1, 2,
            component_upgrade) ||
        !registry.register_component(
            ecs::component_metadata<mesh_renderer_component>().id, 1, 2,
            component_upgrade) ||
        !registry.register_component(
