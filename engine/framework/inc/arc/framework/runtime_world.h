...
public:
    ...
    runtime_world_run_result run_presentation(jobs::job_system& jobs, const simulation_tick& tick,
...
private:
    ...
    runtime_world_run_result run_phase(jobs::job_system& jobs, ecs::system_phase phase,
