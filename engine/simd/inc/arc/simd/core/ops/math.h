 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> abs(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> saturate(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> sqrt(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> rsqrt(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> reciprocal(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> round(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> floor(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> ceil(const simd<T, N>& value) noexcept
{
 ...
 */
template <class T, std::size_t N> constexpr simd<T, N> trunc(const simd<T, N>& value) noexcept
{
