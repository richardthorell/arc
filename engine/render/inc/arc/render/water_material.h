 ...
 *
 * This uses the existing clustered-forward transmission path so every backend gets Fresnel, scene refraction, and
 * Beer-Lambert attenuation without embedding Water policy in a backend.
 */
